...
<progress id="file" max="100" value="${ surveys.score }">  </progress>
</div>
   <br>
	<div class="box2" style="font-family:verdana; text-align: center">
	<h3>1. 친구에게 먼저 만나자고 연락하는 편이다.</h3>
	<input type="radio" name="myRadio1" onclick = "surveyone1()" value="0">매우 아니다 
	<input type="radio" name="myRadio1" onclick = "surveyone1()" value="1">아니다
	<input type="radio" name="myRadio1" onclick = "surveyone1()" value="2">그렇다
	<input type="radio" name="myRadio1" onclick = "surveyone1()" value="3">매우 그렇다
	</div>
	<br>
...
function surveyone1() {
	$.ajax({
		url : "/survey/surveyone1",
		type : "POST",
		async : "false",
		dataType : "json",
		data : { 
		 qnum : $("input[name=myRadio1]:checked").val(),
		 num : 1
		},
